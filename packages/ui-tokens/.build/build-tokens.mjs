...
import { generateSemanticFiles, generateComponentFiles } from "./sd-file-generators.mjs";
...
const components = []; // no components for now
...
beforeRun();
// mitigate race condition on Windows
setTimeout(() => {
  run();
}, 100);
// mitigate race condition on Windows
